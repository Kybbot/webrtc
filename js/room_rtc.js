const APP_ID = "0d4cf4a779a84699b59d5897b5ee1c07";
const token = null;

const streamsCon = document.getElementById("streams__container");
...
const joinStream = async () => {
	...
	streamsCon.insertAdjacentHTML("beforeend", player);
